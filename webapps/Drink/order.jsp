...
<%
  database.connectDB();
  database.query("select * from team8;");
  ResultSet rs = database.getRS();
  request.setCharacterEncoding("UTF-8");
  String id = request.getParameter("id");
  String drink_id = request.getParameter("drink_id");
  String numbers = request.getParameter("number");
  String shop_id = request.getParameter("sid");
  String message="";
  if(drink_id != null && numbers != null && shop_id != null){
    database.connectDB();
    database.insertData(drink_id,numbers,shop_id);
    message="ok";
